...
import munni.priyanka.dg.scientificcalculator.JsCallback;
import munni.priyanka.dg.scientificcalculator.JsEvaluator;
...
public class ScientificCalculatorActivity extends AppCompatActivity {
    ...
    public  void showdialogOnStart() {
        new AlertDialog.Builder(ScientificCalculatorActivity.this).setTitle("Welcome !")
                .setMessage("Scientific Calculator is designed by MUNMUN PRASAD.")
