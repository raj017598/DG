...
public class CalculatorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num9 = (Button) findViewById(R.id.num9); zero = (Button) findViewById(R.id.zero);
        decimal = (Button) findViewById(R.id.decimal); back = (Button) findViewById(R.id.back);
        equalTo = (Button) findViewById(R.id.equalTo); plus = (Button) findViewById(R.id.plus);
        minus = (Button) findViewById(R.id.minus); multiply = (Button) findViewById(R.id.multiple);
        divide = (Button) findViewById(R.id.divide); percent = (Button) findViewById(R.id.percent);
        plusminus = (Button) findViewById(R.id.plusminus); she = (Button) findViewById(R.id.she);
        str0 = str1 = str2 = "";
        try {
            ...
            num9.setOnClickListener(this); zero.setOnClickListener(this);
            decimal.setOnClickListener(this); plusminus.setOnClickListener(this);
            plus.setOnClickListener(this); minus.setOnClickListener(this);
            multiply.setOnClickListener(this); divide.setOnClickListener(this);
            she.setOnClickListener(this); equalTo.setOnClickListener(this);
            percent.setOnClickListener(this); back.setOnClickListener(this); }
        catch (Exception e) { }
    }
    @Override
    ...
    public void plusminus_operation() {
        if (!str2.isEmpty()) {
            str2 = String.valueOf(Integer.parseInt(str2) - (2 * Integer.parseInt(str2)));
            operation(str1);
            onGoing_Operation.setText(str0 + str1 + "(" + str2 + ")");
            enterData.setText(String.valueOf(operation(str1)));
        } else {
            ...
            if(!str0.equalsIgnoreCase("0"))
                str0 = String.valueOf(Integer.parseInt(str0) - (2 * Integer.parseInt(str0)));
            else
                str0 = "-";
            onGoing_Operation.setText(str0 + str1 + str2);
            enterData.setText(onGoing_Operation.getText());
    ...
    {
        new AlertDialog.Builder(CalculatorActivity.this).setTitle("Welcome !")
                .setMessage("Calculator is designed by DEVASHISH MAHATO.")
